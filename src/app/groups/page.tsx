                ...
                >
                  <div className="flex justify-between items-start relative z-10">
                    ...
                    <button 
                      ...
                      className="text-red-400 md:opacity-0 group-hover:opacity-100 transition-opacity p-2.5 hover:bg-red-50 rounded-2xl active:scale-90"
                      title="그룹 삭제"
                    >
                      <TrashIcon />
                    </button>
                  ...
                  <div className="mt-8 flex -space-x-3 relative z-10">
                    {group.members?.slice(0, 5).map((member, i) => (
                      <div 
                        key={member.id} 
                        className="w-10 h-10 rounded-full bg-brand-warm border-2 border-white flex items-center justify-center text-xs font-black overflow-hidden shadow-sm"
